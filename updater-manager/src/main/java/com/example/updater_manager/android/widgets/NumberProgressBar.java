...
package com.example.updater_manager.android.widgets;
...
public class NumberProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawReachedBar) {
            canvas.drawRoundRect(mReachedRectF,11,11, mReachedBarPaint);
        }

        if (mDrawUnreachedBar) {
            canvas.drawRoundRect(mUnreachedRectF,11,11, mUnreachedBarPaint);
        }
    ...
    protected void calculateDrawRectFWithoutProgressText() {
